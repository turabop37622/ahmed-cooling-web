...
export default function WhatsAppButton() {
  ...
  // On service detail page, the fixed bottom bar already has a WhatsApp button on mobile
  ...
  return (
    <button
      onClick={handleClick}
      className={`fixed bottom-6 z-50 h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-500/30 transition-transform hover:scale-110 active:scale-95 ${
        isServiceDetailPage ? 'hidden lg:flex' : 'flex'
